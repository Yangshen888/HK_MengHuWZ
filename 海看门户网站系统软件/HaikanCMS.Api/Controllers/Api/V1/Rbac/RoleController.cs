...
using HaikanCMS.Api.RequestPayload.Rbac.Role;
...
namespace HaikanCMS.Api.Controllers.Api.V1.Rbac
{
    ...
    public class RoleController : ControllerBase
    {
        ...
        public RoleController(haiKanChemistryContext dbContext, IMapper mapper)
        {
...
WHERE URM.UserUUID={0}";
        ...
        private ResponseModel UpdateIsDelete(CommonEnum.IsDeleted isDeleted, string ids)
        {
            using (_dbContext)
            {
                ...
                ToLog.AddLog("删除", "成功:删除:系统角色管理列表数据", _dbContext);
                var response = ResponseModelFactory.CreateInstance;
                return response;
            }
        }
